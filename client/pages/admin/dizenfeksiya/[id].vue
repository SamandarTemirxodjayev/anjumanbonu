...
<script setup>
  ...
  onMounted(async () => {
    ...
    try {
      ...
      const response = await $host.get("/admin/dizenfeksiya/" + router.params.id);
  ...
  const handleSubmit = async (e) => {
    ...
    e.preventDefault();
    try {
      const response = await $host.put("/admin/dizenfeksiya/" + router.params.id, {
        name: name.value,
        type: type.value,
        price: price.value,
  ...
  const deleteUser = async () => {
    loading.value = true;
    try {
      await $host.delete("/admin/dizenfeksiya/" + router.params.id);
      alert("O'chirildi");
      navigateTo("/admin/dizenfeksiya");
    } catch (error) {
      console.log(error);
    }
  };
